...
function DeprecatedMethod(reason, replacementMethod) {
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = function () {
            ...
            console.log("Warning: Method \"".concat(String(propertyKey), "\" is deprecated. Reason: ").concat(reason));
            if (replacementMethod) {
                console.log("You can use \"".concat(replacementMethod, "\" instead."));
            }
...
var MyClass = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _oldMethod_decorators = [DeprecatedMethod("This method is deprecated", "newMethod")];
